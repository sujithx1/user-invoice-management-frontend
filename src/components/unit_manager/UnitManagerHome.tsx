...
// interface UnitManagerHomeProps {
//   currentRole: any;
//   IconComponent: any;
//   getRoleDisplayName: (role: string) => string;
// }

// const UnitManagerHome: React.FC<UnitManagerHomeProps> = ({ currentRole, IconComponent, getRoleDisplayName }) => {
//   return (
...
// export default UnitManagerHome;
